...
urlpatterns = [
    ...
    path("profile/update", user_profile.UpdateUserProfileView.as_view(), name="update user profile"),
    ...
    path('friends/add', friends.SendFriendRequestView.as_view(), name="send friend request"),
    path('friends/cancel', friends.CancelPendingFriendView.as_view(), name="cancel sent pending friend request"),
    path('friends/accept', friends.AcceptFriendView.as_view(), name="accept friend request"),
    path('friends/reject', friends.RejectFriendView.as_view(), name="reject friend request"),
    path('friends/remove', friends.RemoveFriendView.as_view(), name="unfriend a friend"),
    path('friends/pending', friends.GetPendingFriendsView.as_view(), name="get pending friend list"),

    path('activity', activity.GetFriendActivityView.as_view(), name="get activities between user and friends"),
    path('activity/poke', activity.PokeFriendView.as_view(), name="poke a friend"),
    path('activity/accept', activity.AcceptActivityFriendView.as_view(), name="accept a pending friend activity"),
    path('activity/reject', activity.RejectActivityView.as_view(), name="reject a pending friend activity"),
    path('activity/challenge', activity.ChallengeFriendView.as_view(), name="challenge a friend"),
    path('activity/cancel', activity.CancelActivityView.as_view(), name="cancel a pending activity"),


    path('workout/', workout.GetWorkoutRecordView.as_view(), name="get workout records"),
    path('workout/add', workout.CreateWorkoutRecordView.as_view(), name="create new workout record"),
    path('workout/update', workout.UpdateWorkoutRecordView.as_view(), name="update workout records"),
]
