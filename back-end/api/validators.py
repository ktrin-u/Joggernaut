...
def validate_phoneNumber(value: str) -> None:
    ...
    if value[:4] not in VALIDPREFIX:
        raise ValidationError(
            f"Mobile prefix {value[:4]} is not a valid mobile prefix in the Philippines"
        )
...
class CustomPasswordValidator:
    ...
    def get_help_test(self) -> str:
        return "The password must have at least: 7 characters, 1 capital letter, 1 number, 1 special character."
