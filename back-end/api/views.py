...
from .models import UserProfiles, User, FriendTable, WorkoutRecord
...
class CreateWorkoutRecordView(GenericAPIView):
    serializer_class = custom_serializers.NewWorkoutRecordSerializer
    permission_classes = [TokenHasScope]
    required_scopes = ["write"]
    ...
    @extend_schema(
        ...
        request=custom_serializers.NewWorkoutRecordRequestSerializer,
    )
    def post(self, request: Request) -> Response:
        user = get_user_object(request)
        if user is None:
...
class GetWorkoutRecordView(GenericAPIView):
    serializer_class = custom_serializers.GetWorkoutRecordSerializer
    permission_classes = [TokenHasScope]
    required_scopes = ["read"]
    model = WorkoutRecord
...
class UpdateWorkoutRecordView(GenericAPIView):
    serializer_class = custom_serializers.UpdateWorkoutRecordSerializer
    permission_classes = [TokenHasScope]
    required_scopes = ["write"]
    model = WorkoutRecord
    ...
    @extend_schema(
        ...
        request=custom_serializers.UpdateWorkoutRecordSerializer,
        responses={
